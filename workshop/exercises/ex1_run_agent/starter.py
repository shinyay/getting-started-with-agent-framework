...
# Solution reference: src/demo1_run_agent.py
...
async def main() -> None:
    ...
    # ----------------------------------------------------------------
    # TODO(1): Create an async AzureCliCredential context manager
    ...
    #
    # TODO(3): Call agent.run() with a prompt and print result.text
    #   Prompt: "Plan a corporate holiday party for 50 people
