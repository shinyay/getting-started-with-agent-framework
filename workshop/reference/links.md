...
| Workflow checkpoints | https://learn.microsoft.com/en-us/agent-framework/user-guide/workflows/checkpoints |
| Enable observability | https://learn.microsoft.com/en-us/agent-framework/tutorials/agents/enable-observability |
...
| DevUI tracing & observability | https://learn.microsoft.com/en-us/agent-framework/user-guide/devui/tracing |
| A2A integration | https://learn.microsoft.com/en-us/agent-framework/user-guide/hosting/agent-to-agent-integration |
| A2A authentication (Foundry) | https://learn.microsoft.com/en-us/azure/ai-foundry/agents/concepts/agent-to-agent-authentication?view=foundry |
...
| Web search tool (Bing grounding) | https://learn.microsoft.com/en-us/azure/ai-foundry/agents/how-to/tools/web-search?view=foundry |
...
| Title | URL |
|---|---|
| Advanced Multi-Agent Orchestration with SWE Agents and Microsoft Agent Framework (Microsoft Reactor) | https://developer.microsoft.com/en-us/reactor/events/26581/ |
